...
const ASignIn=()=>{
    ...
    <div className="container">
        <p className="h1 text-center p-5 stdlogin">Admin Login</p>
                ...
                <div className="col-12 mx-auto">
                    <form method="post" className="p-3">
                        <div className="mb-4 input-group">
                            ...
                            <input type="email" className="form-control bg-transparent text-white border border-dark shadow rounded" id="exampleInputEmail1"
                            name="email"
                            value={email}
